...
if st.button("📊 Ver Histórico e IA"):
    ...
    if not df_historico.empty:
        ...
        if not df_contagem.empty:
            ...
            ax.plot(dias_futuros, forecast_values, marker='o', linestyle='dashed', color='red', label=forecast_model_label)
        else:
            ...
            ax.plot(dias_futuros, forecast_values, marker='o', linestyle='dashed', color='red', label="Previsão IA (valores corrigidos)")
